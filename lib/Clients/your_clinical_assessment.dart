...
class YourClinicalAssessment extends StatefulWidget {
  const YourClinicalAssessment({super.key});

  @override
  State<YourClinicalAssessment> createState() => _YourClinicalAssessmentState();
}

class _YourClinicalAssessmentState extends State<YourClinicalAssessment> {
