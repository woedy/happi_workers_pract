...
class EditPracticedDetails extends StatefulWidget {
  const EditPracticedDetails({super.key});

  @override
  State<EditPracticedDetails> createState() => _EditPracticedDetailsState();
}

class _EditPracticedDetailsState extends State<EditPracticedDetails> {
